...
export default function Footer() {
  return (
    <footer className="bg-[#1A1A18] px-10 pt-14 pb-7">
      <div className="max-w-[900px] mx-auto grid grid-cols-4 gap-8 pb-9 border-b border-white/[0.07] mb-7">
        <div>
        ...
        <div>
          <h4 className="font-sans text-[10px] tracking-[0.2em] uppercase text-[#C4A882] mb-3">Sider</h4>
        ...
        <div>
          <h4 className="font-sans text-[10px] tracking-[0.2em] uppercase text-[#C4A882] mb-3">Åpningstider</h4>
        ...
        <div>
          <h4 className="font-sans text-[10px] tracking-[0.2em] uppercase text-[#C4A882] mb-3">Finn oss</h4>
